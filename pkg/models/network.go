...
type NetworkDto struct {
	...
	IPs              datatypes.JSONSlice[string] `json:"ips,omitempty" example:"100.100.0.0/22" swaggertype:"array,string"`
	Subnets          datatypes.JSONSlice[string] `json:"subnets,omitempty" example:"192.168.1.0/24" swaggertype:"array,string"`
	Groups           datatypes.JSONSlice[string] `json:"groups,omitempty" example:"laptop,ssh,servers" swaggertype:"array,string"`
	...
	ArgonMemory      uint                        `json:"argon_memory,omitempty" example:"2097152"`
	ArgonIterations  uint                        `json:"argon_iterations,omitempty" example:"2"`
	ArgonParallelism uint                        `json:"argon_parallelism,omitempty" example:"4"`
